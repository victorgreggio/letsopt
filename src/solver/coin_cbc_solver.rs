// COIN-OR CBC Solver Adapter
// Implements the SolverService interface for COIN-OR CBC
// This is an adapter pattern - translates our domain models to good_lp API
